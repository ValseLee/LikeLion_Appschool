...
struct SecondRouletteBoard : View {
	...
	let dinnerDictionaryKey: String = "Dinner"
			...
			ZStack {
				...
				ForEach(1 ..< menuData.userNumber + 1) { index in
					...
					.overlay {
						...
						Text(menuData.menuDictionary[dinnerDictionaryKey]![index - 1])
